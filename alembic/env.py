...
# Override sqlalchemy.url with the sync DB URL from .env (Alembic needs sync driver)
...
# This tells Alembic to diff against our models when autogenerating migrations
