...
async def get_all_users(
    ...
    return await user_service.list_users(uow, limit=limit, offset=offset)
...
async def update_user_role(
    ...
    **Only admins can access this endpoint.**
    ...
    """
    return await user_service.update_user_role(uow, user_id, role_update.role)
...
async def delete_user(
    ...
    **Only admins can access this endpoint.**
    ...
    - Returns 404 if user not found
    """
    return await user_service.soft_delete_user(uow, user_id)
