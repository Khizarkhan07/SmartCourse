...
class DLQReprocessor:
    ...
    def _handle(self, message) -> None:
        ...
        # Calculate remaining wait based on when the message originally failed.
        # On reprocessor restart the message is re-read, so we only wait the
        # time that has NOT already elapsed rather than the full interval again.
